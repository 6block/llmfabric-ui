export default {
  ...
  'resources.worker.driver.install':
    'Install <a href="https://docs.llmfabric.ai/latest/installation/installation-requirements/" target="_blank">required drivers and libraries</a> prior to LLMFabric installation.',
  ...
  'resources.modelfiles.form.localdir.tips':
    'The default storage directory is <span class="desc-block">/var/lib/llmfabric/cache</span>, or the directory specified by <span class="desc-block">--cache-dir</span> (preferred) or <span class="desc-block">--data-dir</span>.',
