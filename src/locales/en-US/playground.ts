export default {
  ...
  'playground.params.size.description':
    'The maximum size of the generated image is controlled by the deployment parameters of the model. <a href="https://github.com/6block/llama-box" target="_blank">Refer to this link</a>',
