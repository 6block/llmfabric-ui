export default {
  ...
  'clusters.create.serverUrl': 'URL сервера LLMFabric',
  ...
  'clusters.addworker.dataVolume': 'Том данных LLMFabric',
  'clusters.addworker.dataVolume.tips':
    'Укажите путь для хранения данных LLMFabric.',
  'clusters.table.ip.internal': 'Внутренний',
  'clusters.table.ip.external': 'Внешний',
  'clusters.form.serverUrl.tips':
    'Если рабочий узел не может напрямую получить доступ к LLMFabric Server, укажите внешний URL службы LLMFabric Server.',
...
// 13. 'clusters.addworker.nvidiaNotes': 'The built-in inference backends in LLMFabric v2.1 require <span class="bold-text">CUDA 12.6+</span>. Please ensure your NVIDIA driver version is <span class="bold-text">560</span> or newer.'
// ================================================================
